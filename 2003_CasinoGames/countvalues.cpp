...
void CBlackjack::countValues()
{
    ...
    //counting the aces
    counter_t numberHumanAces = 0;
    counter_t numberComputerAces = 0;
    ...
    while(numberHumanAces > 0)
    {
        if(humanValueCount <= 10 && numberHumanAces == 1)
        {
            humanValueCount += 11;
            --numberHumanAces;
        }
        else if(humanValueCount <= 10 && numberHumanAces > 1)
        {
            humanValueCount += 1;
            --numberHumanAces;
        }
    ...
    while(numberComputerAces > 0)
    {
        if(computerValueCount <= 10 && numberComputerAces == 1)
        {
            computerValueCount += 11;
            --numberComputerAces;
        }
        else if(computerValueCount <= 10 && numberComputerAces > 1)
        {
            computerValueCount += 1;
            --numberComputerAces;
        }
        else
        {
